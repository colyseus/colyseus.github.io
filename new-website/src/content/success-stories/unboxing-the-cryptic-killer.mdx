...
pubDate: "Aug 22 2023"
heroImage: '/success-stories/elevenpuzzles-screenshot.png'
logoImage: '/success-stories/elevenpuzzles-logo.png'
---
import { Image } from 'astro:assets';
import logoImage from "../../../public/success-stories/elevenpuzzles-logo.png";
import teamImage from "../../../public/success-stories/elevenpuzzles-team.png";
import screenshotImage from "../../../public/success-stories/elevenpuzzles-screenshot.png";
...
<a href="https://store.steampowered.com/app/2069040/Unboxing_the_Cryptic_Killer/">
  <Image class="rounded inline-block mx-auto w-1/2 float-right md:w-1/4 ml-8" src={logoImage} alt="Unboxing the Cryptic Killer" />
</a>
