...
title: "Make it Meme"
author: "Sandro Wahl"
author_img: '/success-stories/make-it-meme-profilepic.png'
author_ref: 'Creator of Make it Meme'
author_link: 'https://www.linkedin.com/in/sandro-wahl-569264200'
quote: "Colyseus allowed me - as a beginner in multiplayer games - to develop a robust backend for my dream game. I had previously never worked with Websockets, authoritative multiplayer servers, or Node.js. But that wasn’t a problem, as Colyseus provided me with an intuitive start. This strong foundation allowed us to grow to where we are today."
# description: 'First release: March 2021'
pubDate: "Aug 30 2023"
heroImage: '/success-stories/make-it-meme-screenshot.png'
logoImage: '/success-stories/make-it-meme-logo.png'
---
import { Image } from 'astro:assets';
import logoImage from "../../../public/success-stories/make-it-meme-logo.png";
import teamImage from "../../../public/success-stories/make-it-meme-team.png";

<Image class="rounded inline-block mx-auto w-1/2 float-right md:w-1/3 ml-8" src={logoImage} alt="Make it Meme Logo" />
...
<Image class="rounded inline-block mx-auto w-1/2 float-right md:float-left md:w-1/3 mr-6" src={teamImage} alt="Make it Meme Logo" />
...
You can reach out to Sandro via [email](mailto:sandro@prealpha.dev?subject=Colyseus%20Success%20Stories&body=Hi%20Sandro%2C), or [LinkedIn](https://www.linkedin.com/in/sandro-wahl-569264200).
