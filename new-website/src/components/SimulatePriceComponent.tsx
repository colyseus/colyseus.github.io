      ...
      <div className="flex flex-col mt-4 space-y-4">
        ...
        <div className="space-y-1">
          ...
          <div>
            ...
            <label htmlFor="scale_horizontal"><span className="bg-blue-600 text-white p-1 text-xs rounded shadow">Coming soon</span> Cluster - Scale horizontally <span className="text-blue-600">(+$100<small>/mo</small>)</span></label>
